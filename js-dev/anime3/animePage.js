...
function createGroupRow(group) {
  ...
  createLink(cell,group.commentCount,'animedb.pl?show=cmt&do=animegroup&agid='+group.agid,'anidb::popup',null,null,'600.500.1.1.agcmts action');
  row.appendChild(cell);
  // Action
	if (uid) {
		cell = document.createElement('TD');
		cell.className = 'action icons';
		createLink(cell,'cmt','animedb.pl?show=cmt&do=animegroup&agid='+group.agid,'anidb::popup',null,'Comment on this release','i_icon i_group_comment 600.500.1.1.agcmts');
