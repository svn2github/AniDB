...
<tmpl_loop name=loop_anime><tmpl_loop name=loop_ep><tmpl_loop name=loop_file># <tmpl_var name=data_file_size_plain>:<tmpl_var name=data_file_ed2k_hash>:<tmpl_var name=data_file_ed2k_name>
221 MYLIST
<tmpl_var name=data_file_lid>|<tmpl_var name=data_file_id>|<tmpl_var name=data_ep_id>|<tmpl_var name=data_anime_id>|<tmpl_var data_file_group_id>|<tmpl_var data_file_ldate>|<tmpl_var data_file_mystate>|<tmpl_var data_file_viewdate>|<tmpl_var data_file_storage>|<tmpl_var data_file_source>|<tmpl_var data_file_other>|<tmpl_var data_file_filestate>
