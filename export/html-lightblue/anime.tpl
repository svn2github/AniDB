...
xa.eps = <tmpl_if name=data_anime_eps><tmpl_var name=data_anime_eps><tmpl_else>0</tmpl_if>;
xa.myEps = <tmpl_var name=data_anime_my_eps>;
xa.myWeps = <tmpl_var name=data_anime_my_watchedeps>;
xa.SEps = <tmpl_if name=data_anime_eps_special><tmpl_var name=data_anime_eps_special><tmpl_else>0</tmpl_if>;
...
xa.myvotedate = "<tmpl_var name=data_anime_my_vote_date_short>";
xa.mytmpvote = "<tmpl_var name=data_anime_my_tmpvote>";
xa.mytmpvotedate = "<tmpl_var name=data_anime_my_tmpvote_date_short>";
