(C) 2004 by fahrenheit [fahrenheit@netcabo.pt]
Version: 2.3 (28.11.2004)
...
Remember the e-mail must be inside the "'" thinguies.
...
On a sidenote, this template and the cleancut one share the same information, so you can basicaly change from one to the other by simply overwriting the *.html and *.js files of one another.
