...
function tabWork() {
	...
	items['all'] =	[titlePrefs, ed2kPrefs, mylistPrefs, mylistPrefs2, groupPrefs, animeLayoutPrefs, otherPrefs];
	...
	var get_info_panime = CookieGet('get_info_panime') || 0;
	var get_info_pmylist = CookieGet('get_info_pmylist') || 0;
	var get_info_sz = CookieGet('get_info_sz') || '150';
	var get_info_mw = CookieGet('get_info_mw') || '450';
