...
#define PACKAGE_VERSION "My Version"
#define PACKAGE_NAME "My Name"
...
extern int audio_flush(int, struct audio_info_struct *);
...
extern void mpg123_init(void);
extern void mpg123_clean(void);
#ifdef USE_WIDE
extern int decode_file(wchar_t *fname);
#else
