...
void File__Base_Format (ZtringListList &Info)
{
    ...
    "TwinVQ;TwinVQ;;A;TwinVQ;;vqf;http://www.twinvq.org/english/index_en.html\n"
...
void File__Base_Codec (ZtringListList &Info)
{
    ...
    "3IV0;3ivX;4CC;V;MPEG-4;;3ivX pre-1.0;http://www.3ivx.com/download/\n"
    "3IV1;3ivX;4CC;V;MPEG-4;;3ivX 1.0-3.5;http://www.3ivx.com/download/\n"
    "3IV2;3ivX;4CC;V;MPEG-4;;3ivX 4.0;http://www.3ivx.com/download/\n"
    "3IVD;3ivX;4CC;V;MPEG-4;;;http://ffdshow.sourceforge.net/tikiwiki/tiki-index.php?page=Getting+ffdshow\n"
    "3IVX;3ivX;4CC;V;MPEG-4;;;http://www.3ivx.com/download/\n"
    "3VID;3ivX;4CC;V;MPEG-4;;;http://www.3ivx.com/download/\n"
    ...
    "AEMI;VideoONE;4CC;V;MPEG-1;;Array VideoONE MPEG-1-I Capture. Array's used for I frame only MPEG-1 AVI files;http://www.array.com\n"
    ...
    "AP41;AngelPotion;4CC;V;MPEG-4;;AngelPotion Definitive 1 (hack of MS MPEG-4 v3);http://www.divxity.com/download/ap4v1-702.exe\n"
    "AP42;AngelPotion;4CC;V;MPEG-4;;AngelPotion Definitive 2 (hack of MS MPEG-4 v3);http://www.divxity.com/download/ap4v1-702.exe\n"
    ...
    "ATM4;Nero MPEG-4;4CC;V;MPEG-4;;Ahead Nero Digital MPEG-4;http://www.nero.com\n"
    ...
    "BIT ;RGB;4CC;V;;;Uncompressed. BI_BITFIELDS\n"
    "BITM;H.261;4CC;V;;;Microsoft H.261\n"
    "BLOX;Blox;4CC;V;;;Jan Jezabek BLOX MPEG;http://www.ii.uj.edu.pl/~jezabek/blox/blox-0.1.0b.zip\n"
    "BLZ0;DivX;4CC;V;MPEG-4;;DivX for Blizzard Decoder Filter;http://ffdshow.sourceforge.net/tikiwiki/tiki-index.php?page=Getting+ffdshow\n"
    ...
    "CLPL;YUV;4CC;V;;;Format similar to YV12 but including a level of indirection.\n"
    "CM10;MediaShow;4CC;V;;;CyberLink Corporation;http://www.cyberlink.com\n"
    "CMYK;CMYK;4CC;V;;;Common Data Format in Printing\n"
    "COL0;MS MPEG-4 v3;4CC;V;;;Hacked MS MPEG-4 v3;http://ffdshow.sourceforge.net/tikiwiki/tiki-index.php?page=Getting+ffdshow\n"
    "COL1;MS MPEG-4 v3;4CC;V;;;Hacked MS MPEG-4 v3;http://ffdshow.sourceforge.net/tikiwiki/tiki-index.php?page=Getting+ffdshow\n"
    ...
    "DAVC;H.264;4CC;V;;;Dicas MPEGable H.264/MPEG-4 AVC base profile\n"
    ...
    "DIV1;FFMpeg;4CC;V;MPEG-4;;FFmpeg-4 V1 (hacked MS MPEG-4 V1);http://ffdshow.sourceforge.net/tikiwiki/tiki-index.php?page=Getting+ffdshow\n"
    "DIV2;MS MPEG-4 1/2;4CC;V;MPEG-4;;;http://ffdshow.sourceforge.net/tikiwiki/tiki-index.php?page=Getting+ffdshow\n"
    "DIV3;DivX 3 Low;4CC;V;MPEG-4;;;http://www.divx.com\n"
    "DIV4;DivX 3 Fast;4CC;V;MPEG-4;;;http://www.divx.com\n"
    "DIV5;DivX 5;4CC;V;MPEG-4;;;http://www.divx.com\n"
    "DIV6;MS MPEG-4 v3;4CC;V;MPEG-4;;MS MPEG-4 v3;http://ffdshow.sourceforge.net/tikiwiki/tiki-index.php?page=Getting+ffdshow\n"
    "DIVX;DivX 4;4CC;V;MPEG-4;;Project Mayo DivX 4;http://www.divx.com\n"
    "divx;DivX;4CC;V;MPEG-4;;Mainly used by Google;http://www.divx.com\n"
    "DJPG;Broadway 101;4CC;V;M-JPEG;;Data Translation, Inc.\n"
    "DM4V;Dicas;4CC;V;MPEG-4;;Dicas MPEGable MPEG-4\n"
    ...
    "DP02;DynaPel;4CC;V;MPEG-4;;DynaPel MPEG-4\n"
    ...
    "DX50;DivX 5;4CC;V;MPEG-4;;;http://www.divx.com\n"
    ...
    "FMP4;MPEG-4 Visual;4CC;V;MPEG-4;;;http://ffdshow.sourceforge.net/tikiwiki/tiki-index.php?page=Getting+ffdshow\n"
    ...
    "GPEG;Gabest;4CC;V;;;M-JPEG by Gabest (with floating point);http://sourceforge.net/project/showfiles.php?group_id=82303&package_id=84358\n"
    "GPJM;Pinnacle M-JPEG;4CC;V;;;Pinnacle ReelTime M-JPEG\n"
    ...
    "H264;Intel H.264;4CC;V;;;Intel H.264\n"
    ...
    "MJPB;Pinacle M-JPEG B;4CC;V;;;M-JPEG\n"
    "MJPG;M-JPEG;4CC;V;;;M-JPEG including Huffman Tables\n"
    "mJPG;IBM M-JPEG (w Huffman);4CC;V;;;IBM M-JPEG including Huffman Tables\n"
    "MJPX;Pegasus M-JPEG;4CC;V;;;Pegasus PICVideo M-JPEG\n"
    "ML20;Webcam;4CC;V;;;Mimic MSN Messenger Webcam\n"
    "MMES;Matrox MPEG-2;4CC;V;;;Matrox MPEG-2 I-frame\n"
    "MMIF;Matrox MPEG-2;4CC;V;;;Matrox MPEG-2 I-frame\n"
    "MNVD;MindVid;4CC;V;;;MindBend MindVid LossLess\n"
    "MP2A;MPEG-2 Audio;4CC;A;;;Media Excel MPEG-2 Audio\n"
    "MP2T;MPEG-2 TS;4CC;M;;;Media Excel MPEG-2 Transport Stream\n"
    "MP2V;MPEG-2 Video;4CC;V;;;Media Excel MPEG-2 Video;http://ffdshow.sourceforge.net/tikiwiki/tiki-index.php?page=Getting+ffdshow\n"
    "MP2v;MPEG-2 Video;4CC;V;;;MPEG-2 Video;http://ffdshow.sourceforge.net/tikiwiki/tiki-index.php?page=Getting+ffdshow\n"
    ...
    "mp4a;AAC;4CC;A;;;AAC;http://ffdshow.sourceforge.net/tikiwiki/tiki-index.php?page=Getting+ffdshow\n"
    "MP4A;MPEG-4 Audio;4CC;A;;;Media Excel MPEG-4 Audio;http://www.apple.com/quicktime/download/standalone.html\n"
    "MP4S;MS MPEG-4 v3;4CC;V;;;Microsoft MPEG-4 (Windows Media 7.0)\n"
    "mp4s;MPEG-4 TS;4CC;V;;;(MPEG-4) Apple MPEG-4 Transport Stream;http://ffdshow.sourceforge.net/tikiwiki/tiki-index.php?page=Getting+ffdshow\n"
    "MP4T;MPEG-4 TS;4CC;M;;;Media Excel MPEG-4 Transport Stream;http://www.apple.com/quicktime/download/standalone.html\n"
    "MP4V;MPEG-4 Video;4CC;V;;;Apple QuickTime MPEG-4 native;http://ffdshow.sourceforge.net/tikiwiki/tiki-index.php?page=Getting+ffdshow\n"
    "mp4v;MPEG-4 Video;4CC;V;;;(MPEG-4) Apple MPEG-4 Video;http://www.apple.com/quicktime/download/standalone.html\n"
    "MPEG;MPEG;4CC;V;;;Chromatic MPEG 1 Video I Frame;http://ffdshow.sourceforge.net/tikiwiki/tiki-index.php?page=Getting+ffdshow\n"
    "mpeg;MPEG;4CC;V;;;MPEG-1 Video;http://ffdshow.sourceforge.net/tikiwiki/tiki-index.php?page=Getting+ffdshow\n"
    "MPG1;FFmpeg MPEG 1/2;4CC;V;;;(MPEG-1/2) FFmpeg;http://ffdshow.sourceforge.net/tikiwiki/tiki-index.php?page=Getting+ffdshow\n"
    "MPG2;FFmpeg MPEG 1/2;4CC;V;;;(MPEG-1/2) FFmpeg;http://ffdshow.sourceforge.net/tikiwiki/tiki-index.php?page=Getting+ffdshow\n"
    "MPG3;FFmpeg DivX 3;4CC;V;;;(MPEG-4) MS MPEG-4 v3\n"
    "MPG4;MS MPEG-4 v1;4CC;V;;;Microsoft MPEG-4 v1\n"
    "MPGI;Sigma MPEG;4CC;V;;;Sigma Design MPEG-1 I-frame\n"
    ...
    "MTX1;Matrox M-JPEG;4CC;V;;;Matrox M-JPEG\n"
    "MTX2;Matrox M-JPEG;4CC;V;;;Matrox M-JPEG\n"
    "MTX3;Matrox M-JPEG;4CC;V;;;Matrox M-JPEG\n"
    "MTX4;Matrox M-JPEG;4CC;V;;;Matrox M-JPEG\n"
    "MTX5;Matrox M-JPEG;4CC;V;;;Matrox M-JPEG\n"
    "MTX6;Matrox M-JPEG;4CC;V;;;Matrox M-JPEG\n"
    "MTX7;Matrox M-JPEG;4CC;V;;;Matrox M-JPEG\n"
    "MTX8;Matrox M-JPEG;4CC;V;;;Matrox M-JPEG\n"
    "MTX9;Matrox M-JPEG;4CC;V;;;Matrox M-JPEG\n"
    ...
    "NAVI;MS MPEG-4;4CC;V;;;nAVI video (hacked MS MPEG-4)\n"
    "NDIG;Ahead MPEG-4;4CC;V;;;Ahead Nero Digital MPEG-4\n"
    ...
    "PIM1;Pegasus M-JPEG;4CC;V;;;Pinnacle DC1000 hardware (MPEG compression);http://mirror01.iptelecom.net.ua/~video/codecs/PICVideo.Lossless.JPEG.codec.v2.10.27.exe\n"
    "PIM2;Pegasus M-JPEG;4CC;V;;;Pegasus Imaging;http://mirror01.iptelecom.net.ua/~video/codecs/PICVideo.Lossless.JPEG.codec.v2.10.27.exe\n"
    "PIMJ;Pegasus M-JPEG;4CC;V;;;Pegasus Imaging PICvideo Lossless JPEG;http://mirror01.iptelecom.net.ua/~video/codecs/PICVideo.Lossless.JPEG.codec.v2.10.27.exe\n"
    ...
    "PVMM;Pegasus MPEG-4;4CC;V;MPEG-4;;PacketVideo Corporation MPEG-4\n"
    ...
    "RMP4;RealMagic MPEG-4;4CC;V;MPEG-4;;REALmagic MPEG-4 Video (Sigma Design, built on XviD)\n"
    ...
    "s422;VideoCap C210;4CC;V;YUV;;VideoCap C210\n"
    "SAMR;AMR;4CC;A\n"
    "SAN3;SAN3;4CC;V;MPEG-4;;Direct copy of DivX 3.11\n"
    "SANM;Smush v2;4CC;V;;;LucasArts;http://www.lucasarts.com/\n"
    "SCCD;SoftCam;4CC;V\n"
    "SDCC;Sun DV;4CC;V;DV;;Sun Digital Camera\n"
    "SEDG;Samsung MPEG-4;4CC;V;MPEG-4;;Samsung MPEG-4\n"
    ...
    "SLIF;SoftLab MPEG-2;4CC;V;;;SoftLab-NSK MPEG-2 I-frames\n"
    "SLMJ;SoftLab M-JPEG;4CC;V;;;SoftLab-NSK Forward M-JPEG\n"
    ...
    "UMP4;UB MPEG-4;4CC;V;;;UB Video MPEG 4;http://www.fourcc.org/indexyuv.htm\n"
    ...
    "VIDM;DivX 5 pro;4CC;V;;;DivX 5.0 Pro Supported\n"
    ...
    "VSSH;H.264;4CC;V;;;Vanguard VSS H.264\n"
    "VSSV;Vanguard Video;4CC;V;;;Vanguard Software Solutions Video\n"
    "VSSW;H.264;4CC;V;;;Vanguard VSS H.264\n"
    ...
    "x263;Xirlink;4CC;V\n"
    "X264;H.264;4CC;V;MPEG-4;;XiWave GNU GPL x264 MPEG-4\n"
    "x264;H.264;4CC;V;MPEG-4;;XiWave GNU GPL x264 MPEG-4\n"
    "XJPG;Xirlink;4CC;V;M-JPEG;;Xirlink, Inc.\n"
    "XLV0;NetXL Video;4CC;V;;;NetXL Inc. XL Video Decoder\n"
    "XMPG;Xing MPEG;4CC;V;;;XING MPEG (I frame only)\n"
    "XVID;XviD;4CC;V;MPEG-4;;XviD project;http://www.koepi.org/xvid.shtml\n"
    "XVIX;XviD;4CC;V;MPEG-4;;Based on XviD MPEG-4;http://www.koepi.org/xvid.shtml\n"
    ...
    "V_MPEG4/ISO/SP;MPEG-4 SP;Mk;V;;;MPEG4 ISO simple profile;http://www.divx.com\n"
    "V_MPEG4/ISO/ASP;MPEG-4 ASP;Mk;V;;;MPEG4 ISO advanced simple profile;http://www.koepi.org/xvid.shtml\n"
    "V_MPEG4/ISO/AP;MPEG-4 ASP;Mk;V;;;MPEG4 ISO advanced profile;http://ffdshow.sourceforge.net/tikiwiki/tiki-index.php?page=Getting+ffdshow\n"
    "V_MPEG4/ISO/AVC;MPEG-4 AVC;Mk;V;;;MPEG4 ISO advanced profile;http://ffdshow.sourceforge.net/tikiwiki/tiki-index.php?page=Getting+ffdshow\n"
    "V_MPEG4/MS/V2;MS MPEG4 v2;Mk;V;;;(MPEG4) MS MPEG-4 v2;http://ffdshow.sourceforge.net/tikiwiki/tiki-index.php?page=Getting+ffdshow\n"
    "V_MPEG4/MS/V3;MS MPEG4 v3;Mk;V;;;(MPEG4) MS MPEG-4 v3;http://ffdshow.sourceforge.net/tikiwiki/tiki-index.php?page=Getting+ffdshow\n"
    "V_MPEG1;MPEG;Mk;V;;;(MPEG1) MPEG 1 or 2 Video;http://ffdshow.sourceforge.net/tikiwiki/tiki-index.php?page=Getting+ffdshow\n"
    "V_MPEG2;MPEG;Mk;V;;;(MPEG1) MPEG 1 or 2 Video;http://ffdshow.sourceforge.net/tikiwiki/tiki-index.php?page=Getting+ffdshow\n"
    ...
    "A_MPEG/L1;MPEG1/2 L1;Mk;A;;;MPEG1 or 2 Audio layer 1;http://www.iis.fraunhofer.de/amm/index.html\n"
    "A_MPEG/L2;MPEG1/2 L2;Mk;A;;;MPEG1 or 2 Audio layer 2;http://www.iis.fraunhofer.de/amm/index.html\n"
    "A_MPEG/L3;MPEG1/2 L3;Mk;A;;;MPEG1 or 2 Audio Layer 3;http://www.iis.fraunhofer.de/amm/index.html\n"
    "A_PCM/INT/BIG;PCM;Mk;A\n"
    "A_PCM/INT/LIT;PCM;Mk;A\n"
    "A_PCM/FLOAT/IEEE;FLOAT;Mk;A;;;Microsoft FLOAT;http://www.microsoft.com/windows/\n"
    "A_AC3;AC3;Mk;A;;;Dolby AC3\n"
    "A_AC3/BSID9;AC3;Mk;A;;;Dolby AC3\n"
    "A_AC3/BSID10;AC3;Mk;A;;;Dolby AC3\n"
    "A_DTS;DTS;Mk;A\n"
    "A_VORBIS;Vorbis;Mk;A;;VBR;;http://www.vorbis.com\n"
    "A_WAVPACK4;WavePack;Mk;A;;VBR;;http://www.wavepack.com\n"
    "A_REAL/14_4;RealAudio 1;Mk;A;;;Real Audio 1 (14.4);http://www.real.com\n"
    "A_REAL/28_8;RealAudio 2;Mk;A;;;Real Audio 2 (28.8);http://www.real.com\n"
    "A_REAL/COOK;RealAudio 7;Mk;A;;;Real Audio Cook Codec (codename: Gecko);http://www.real.com\n"
    "A_REAL/SIPR;RealAudio 4;Mk;A;;;Real & Sipro Voice Codec;http://www.real.com\n"
    "A_REAL/RALF;RealAudio Lossless;Mk;A;;;Real Audio Lossless Format;http://www.real.com\n"
    "A_REAL/ATRC;RealAudio Atrac3;Mk;A;;;Real & Sony Atrac3 Codec;http://www.real.com\n"
    "A_AAC/MPEG2/MAIN;AAC Main;Mk;A;;;AAC Main Profile\n"
    "A_AAC/MPEG2/LC;AAC LC;Mk;A;;;AAC Low Complexity\n"
    "A_AAC/MPEG2/LC/SBR;AAC LC-SBR;Mk;A;;;AAC Low Complexity with Spectral Band Replication\n"
    "A_AAC/MPEG2/SSR;AAC SSR;Mk;A;;;AAC Scalable Sampling Rate\n"
    "A_AAC/MPEG4/MAIN;AAC Main;Mk;A;;;AAC Main Profile\n"
    "A_AAC/MPEG4/LC;AAC LC;Mk;A;;;AAC Low Complexity\n"
    "A_AAC/MPEG4/LC/SBR;AAC LC-SBR;Mk;A;;;AAC Low Complexity with Spectral Band Replication\n"
    "A_AAC/MPEG4/LC/SBR/PS;AAC LC-SBR-PS;Mk;A;;;AAC Low Complexity with Spectral Band Replication and Parametric Stereo\n"
    "A_AAC/MPEG4/SSR;AAC SSR;Mk;A;;;AAC Scalable Sampling Rate\n"
    "A_AAC/MPEG4/LTP;AAC LTP;Mk;A;;;AAC Long Term Prediction\n"
    ...
    "dnet;AC3;Real;A;;;A52/AC3, Real Audio 2;http://www.real.com\n"
    ...
    "raac;AAC-LC;Real;A;;;Real Audio 10 AAC LC;http://www.real.com\n"
    "racp;AAC-HE;Real;A;;;Real Audio 10 AAC-HE;http://www.real.com\n"
    "Vorbis;Vorbis;Ogg;A;;;;http://www.vorbis.com\n"
    "Theora;Theora;Ogg;V;;;;http://www.theora.com\n"
    "mp4a;AAC;4CC;A;;;AAC (3GPP);http://www.apple.com/quicktime/download/standalone.html\n"
    "mp4v;MPEG-4;4CC;V;;;MPEG-4 Video (3GPP);http://www.apple.com/quicktime/download/standalone.html\n"
    "avc1;H.264;4CC;V;;;H.264 (3GPP);http://www.apple.com/quicktime/download/standalone.html\n"
    ...
    ".mp3;MPEG-1/2 L3;2CC;A;MPEG-1;;MPEG-1 or 2 layer 3;http://www.iis.fraunhofer.de/amm/index.html\n"
    "MPEG-4 AAC main;AAC Main;Mp4v2;A\n"
    "MPEG-4 AAC LC;AAC LC;Mp4v2;A\n"
    "MPEG-4 AAC SSR;AAC SSR;Mp4v2;A\n"
    "MPEG-4 AAC LTP;AAC LTP;Mp4v2;A\n"
    "MPEG-4 Simple @ L0;MPEG-4 Simple@L0;Mp4v2;V\n"
    "MPEG-4 Simple @ L1;MPEG-4 Simple@L1;Mp4v2;V\n"
    "MPEG-4 Simple @ L2;MPEG-4 Simple@L2;Mp4v2;V\n"
    "MPEG-4 Simple @ L3;MPEG-4 Simple@L3;Mp4v2;V\n"
    "MPEG-4 Adv Simple@L0;MPEG-4 Adv Simple@L0;Mp4v2;V\n"
    "MPEG-4 Adv Simple@L1;MPEG-4 Adv Simple@L1;Mp4v2;V\n"
    "MPEG-4 Adv Simple@L2;MPEG-4 Adv Simple@L2;Mp4v2;V\n"
    "MPEG-4 Adv Simple@L3;MPEG-4 Adv Simple@L3;Mp4v2;V\n"
    "MPEG-4 Adv Simple@L4;MPEG-4 Adv Simple@L4;Mp4v2;V\n"
    "MPEG-4 Adv Simple@L5;MPEG-4 Adv Simple@L5;Mp4v2;V\n"
    "AVC;AVC;MediaInfo;V;;;MPEG-4 AVC;http://developers.videolan.org/x264.html\n"
    "MPEG-1V;MPEG-1 Video;MediaInfo;V\n"
    "MPEG-2V;MPEG-2 Video;MediaInfo;V\n"
    "MPEG-4V;MPEG-4 Visual;MediaInfo;V\n"
    "MPEG-1A;MPEG-1 Audio;MediaInfo;A\n"
    "MPEG-1A L1;MPEG-1 Audio Layer 1;MediaInfo;A\n"
    "MPEG-1A L2;MPEG-1 Audio Layer 2;MediaInfo;A\n"
    "MPEG-1A L3;MPEG-1 Audio Layer 3;MediaInfo;A\n"
    "MPEG-2A;MPEG-2 Audio;MediaInfo;A\n"
    "MPEG-2A L1;MPEG-2 Audio Layer 1;MediaInfo;A\n"
    "MPEG-2A L2;MPEG-2 Audio Layer 2;MediaInfo;A\n"
    "MPEG-2A L3;MPEG-2 Audio Layer 3;MediaInfo;A\n"
    "MPEG-2.5A;MPEG-2.5 Audio;MediaInfo;A\n"
    "MPEG-2.5A L1;MPEG-2.5 Audio Layer 1;MediaInfo;A\n"
    "MPEG-2.5A L2;MPEG-2.5 Audio Layer 2;MediaInfo;A\n"
    "MPEG-2.5A L3;MPEG-2.5 Audio Layer 3;MediaInfo;A\n"
    ...
    "FF;AAC;2CC;A\n"
    "100;ADPCM;2CC;A;;;Rhetorex ADPCM\n"
    ...
    "210;ADPCM;2CC;A;;;UHER informatic GmbH ADPCM\n"
    ...
    "2000;AC3;2CC;A;;CBR;Dolby AC3\n"
    "2001;DTS;2CC;A;;;Digital Theater Systems\n"
    ...
    "674F;Vorbis1;2CC;A;;;Vorbis Mode 1;http://www.vorbis.com\n"
    "6750;Vorbis2;2CC;A;;;Vorbis Mode 2;http://www.vorbis.com\n"
    "6751;Vorbis3;2CC;A;;;Vorbis Mode 3;http://www.vorbis.com\n"
    "676F;Vorbis1+;2CC;A;;;Vorbis Mode 1+;http://www.vorbis.com\n"
    "6770;Vorbis2+;2CC;A;;;Vorbis Mode 2+;http://www.vorbis.com\n"
    "6771;Vorbis3+;2CC;A;;;Vorbis Mode 2+;http://www.vorbis.com\n"
...
void File__Base_General (ZtringListList &Info)
{
    ...
    "RadioStation;;;Y YT;;;;;Legal\n"
    "RadioStation/Owner;;;Y YT;;;;;Legal\n"
    "RadioStation/Url;;;Y YT;;;;;Legal\n"
...
void File__Base_Encoder (ZtringListList &Info)
{
    ...
    "DivX503b1697 ;DivX 6.0.3 Fusion (ThermonuclearFusion) ;UTC 2005-10-18\n"
    "DivX503b1612 ;DivX 6.0.0 Helium (GodFatherOfSoul) ;UTC 2005-06-15\n"
    "DivX503b1599;DivX 6.0.0 Helium;UTC 2005-06\n"
    "DivX503b1594;DivX 6.0.0 (DivX Converter 1.0);UTC 2005-06\n"
    "DivX503b1571;DivX 6.0.0;UTC 2005-06-15\n"
    "DivX503b1528;DivX 5.9.0 Fusion (HiggsBoson);UTC 2005-03-05\n"
    "DivX503b1461;DivX 5.9.0 Fusion (HiggsBoson);UTC 2005-01\n"
    "DivX503b1453;DivX 5.9.0 Fusion (InertialConfinement);UTC 2005-01\n"
    "DivX503b1408;DivX 5.3.0 Plasma Alpha (CoreBurn);UTC 2004-10\n"
    "DivX503b1394;DivX 5.3.0 Plasma Alpha (Tritium);UTC 2004-09-08\n"
    "DivX503b1338;DivX 5.2.1 (DrDivX106);UTC 2004-09-08\n"
    "DivX503b1328;DivX 5.2.1 (WaffleDay);UTC 2004-09-08\n"
    "DivX503b1314;DivX 5.2.1 Beta;UTC 2004-09-08\n"
    "DivX503b1307;DivX 5.2.1 Alpha;UTC 2004-09-08\n"
    "DivX503b1272;DivX 5.2.0 (DrDivX105);UTC 2004-07-17\n"
    "DivX503b1263;DivX 5.2.0;UTC 2004-07-15\n"
    "DivX503b1031;DivX 5.1.1 (Maupiti);UTC 2003-11-19\n"
    "DivX503b1025;DivX 5.1.1 Beta 2;UTC 2003-11\n"
    "DivX503b1009;DivX 5.1.1 Beta 1;UTC 2003-10-21\n"
    "DivX503b0985;DivX 5.1.0 (HD?);UTC 2003-10\n"
    "DivX503b959;DivX 5.1.0;UTC 2003-09-02\n"
    "DivX503b936;DivX 5.1.0 Beta 2 (Kaukura);UTC 2003-08-02\n"
    "DivX503b922;DivX 5.1.0 Beta 1 (Manihi);UTC 2003-07-26\n"
    "DivX503b894;DivX 5.0.5 Kauehi;UTC 2003-07-02\n"
    "DivX503b830;DivX 5.0.5;UTC 2003-04-24\n"
    "DivX503b822;DivX 5.0.4;UTC 2003-04-17\n"
    "DivX503b814 ;DivX 5.0.4 Beta 4 (Schizo);UTC 2003-01\n"
    "DivX503b804 ;DivX 5.0.4 Beta 3 (Schizo);UTC 2003-01\n"
    "DivX503b795 ;DivX 5.0.4 Beta 1 or 2 (Schizo);UTC 2003-01\n"
    "DivX503b740;DivX 5.0.3;UTC 2003-01-24\n"
    "DivX503b696;DivX 5.0.5 Beta (Tahanea);UTC 2003-01\n"
    ...
    "XviD0044 ;XviD 1.1 1 ;UTC 2006-07-10\n"
    "XviD0043 ;XviD 1.2.0 SMP ;UTC 2006-01-08\n"
    "XviD0042 ;XviD 1.2.0 -127;UTC 2005-12\n"
    "XviD0041 ;XviD 1.1.0;UTC 2005-11-22\n"
    "XviD0040 ;XviD 1.1.0 RC;UTC 2005-11-22\n"
    "XviD0039 ;XviD 1.1.0 Beta 2;UTC 2005-04-04\n"
    "XviD0038 ;XviD 1.1.0 Beta 1;UTC 2005-01-16\n"
    ...
    "XviD0033 ;XviD 1.0.0 RC 4d ;UTC 2004-05-03\n"
    "XviD0032 ;XviD 1.0.0 RC 4c ;UTC 2004-05-02\n"
    "XviD0031 ;XviD 1.0.0 RC 4b ;UTC 2004-04-15\n"
    "XviD0030 ;XviD 1.0.0 RC 4 (Hola);UTC 2004-04-05\n"
    "XviD0029 ;XviD 1.0.0 RC 3 (Ni hao);UTC 2004-03-22\n"
    "XviD0028 ;XviD 1.0.0 RC 2 (Jambo) ;UTC 2004-02-01\n"
    "XviD0027 ;XviD 1.0.0 RC 1b ;UTC 2004-01-30\n"
    "XviD0026 ;XviD 1.0.0 RC 1 (Niltze);UTC 2004-01-26\n"
    "XviD0025 ;XviD 1.0.0 Beta 3 (Selam);UTC 2003-12-27\n"
    "XviD0024 ;XviD 1.0.0 Beta 2.5 ;UTC 2003-12-18\n"
    "XviD0023 ;XviD 1.0.0 Beta 2 (Ciao) ;UTC 2003-12-06\n"
    "XviD0022 ;XviD 1.0.0 Beta 1.5 ;UTC 2003-12-03\n"
    "XviD0021 ;XviD 1.0.0 Beta 1 (Aloha) ;UTC 2003-11-29\n"
...
void File__Base_Summary (ZtringListList &Info)
{
    ...
    "Video;[%Language/String%, ][%BitRate/String%, ][%Width%*][%Height%][ (%AspectRatio/String%), ][ $at$ %FrameRate/String%, ][%Codec/String%][ (%Standard%)]$if(%Codec_Profile%, \\(%Codec_Profile%\\))$if(%Codec_Settings%, \\(%Codec_Settings%\\))\n"
    "Audio;[%Language/String%, ][%BitRate/String%, ][%SamplingRate/String%, ][%Channel(s)/String%, ][%Codec/String%]$if(%Codec_Profile%, \\(%Codec_Profile%\\))$if(%Codec_Settings%, \\(%Codec_Settings%\\))\n"
