...
//---------------------------------------------------------------------------
#define MPEG4_ELEMENT_LEVEL_MAX 20
//---------------------------------------------------------------------------
...
private :
    ...
    int32u Element_Name[MPEG4_ELEMENT_LEVEL_MAX]; //4CC of the list type
    int64u Element_Next[MPEG4_ELEMENT_LEVEL_MAX];
    ...
    void Descriptors            ();
    void Descriptor_ES          ();
    void Descriptor_DecConfig   ();
    void Descriptor_DecSpecific ();
    void Descriptor_SLConfig    ();
    void Descriptor_Profiles    ();
...
namespace Mpeg4
{
    ...
    const int32u moov_ctab=0x63746162;
    ...
    const int32u moov_trak_mdia_minf_dinf=0x64696E66;
    const int32u moov_trak_mdia_minf_dinf_url =0x75726C20;
    const int32u moov_trak_mdia_minf_dinf_urn =0x75726E20;
    const int32u moov_trak_mdia_minf_dinf_dref=0x64726566;
    const int32u moov_trak_mdia_minf_dinf_dref_url =0x75726C20;
    const int32u moov_trak_mdia_minf_dinf_derf_urn =0x75726E20;
    const int32u moov_trak_mdia_minf_hint=0x68696E74;
    const int32u moov_trak_mdia_minf_hmhd=0x686D6864;
    const int32u moov_trak_mdia_minf_nmhd=0x6E6D6864;
    const int32u moov_trak_mdia_minf_smhd=0x736D6864;
    const int32u moov_trak_mdia_minf_stbl=0x7374626C;
    const int32u moov_trak_mdia_minf_stbl_ctts=0x63747473;
    const int32u moov_trak_mdia_minf_stbl_stco=0x7374636F;
    const int32u moov_trak_mdia_minf_stbl_stsc=0x73747363;
    ...
    const int32u moov_trak_mdia_minf_stbl_stss=0x73747373;
    ...
    const int32u moov_udta_MCPS=0x4D435053;
