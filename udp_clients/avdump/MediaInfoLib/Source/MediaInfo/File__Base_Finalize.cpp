...
//---------------------------------------------------------------------------
void File__Base::Finalize_Text(size_t Pos)
{
    //Integrity
    if (Pos>=Text.size())
        return;
...
//---------------------------------------------------------------------------
//PlayTime
void File__Base::PlayTime_PlayTime123(const Ztring &Value, stream_t StreamKind, size_t StreamPos)
{
...
//---------------------------------------------------------------------------
//FileSize
void File__Base::FileSize_FileSize123(const Ztring &Value, stream_t StreamKind, size_t StreamPos)
{
    ZtringListList &List=(*Stream[StreamKind])[StreamPos];
    if (List.Find(Value+_T("/String"))==Error || List(Value).empty())
        return;
...
//---------------------------------------------------------------------------
//FileSize
void File__Base::Kilo_Kilo123(const Ztring &Value, stream_t StreamKind, size_t StreamPos)
{
    ZtringListList &List=(*Stream[StreamKind])[StreamPos];
    if (List.Find(Value+_T("/String"))==Error || List(Value).empty())
        return;
...
void File__Base::Value_Value123(const Ztring &Value, stream_t StreamKind, size_t StreamPos)
{
    //String wanted?
    ZtringListList &List=(*Stream[StreamKind])[StreamPos];
