...
int MediaInfo::ListFormats()
{
    ...
    // Multiple
    #if defined(MEDIAINFO_BDAV_YES)
        delete Info; delete Info; Info=new File_Bdav();               if (ApplyMethod()>0) return 1;
    #endif
    #if defined(MEDIAINFO_CDXA_YES)
    ...
    // Audio
    #if defined(MEDIAINFO_AAC_YES)
        delete Info; Info=new File_Aac();                if (ApplyMethod()>0) return 1;
    #endif
    #if defined(MEDIAINFO_AC3_YES)
...
bool MediaInfo::LibraryIsModified ()
{
     ...
     || defined(MEDIAINFO_AAC_NO) || defined(MEDIAINFO_AC3_NO) || defined(MEDIAINFO_AMR_NO) || defined(MEDIAINFO_DTS_NO) || defined(MEDIAINFO_FLAC_NO) || defined(MEDIAINFO_APE_NO) || defined(MEDIAINFO_MPC_NO) || defined(MEDIAINFO_MPEGA_NO) || defined(MEDIAINFO_TWINVQ_NO) \
