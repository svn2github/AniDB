...
public class Preferences extends javax.swing.JFrame {
	...
	public void setSettings() {
		...
		this.parsingVbrBitrateRadioButton.setSelected(this.parsingOptions.getVbr_calc_mode() == avparsing.AVParser.VBR_BY_PACKET_BITRATE);
		this.parsingVbrSizeRadioButton.setSelected(this.parsingOptions.getVbr_calc_mode() == avparsing.AVParser.VBR_BY_PACKET_SIZE);
		...
		if (this.parsingOptions.isEnabled() && !this.parsingOptions.isDisabled() && this.parsingOptions.isFullParse()) {
	...
	private void parsingSettingsEnableCheckBoxItemStateChanged(java.awt.event.ItemEvent evt) {
		...
		if (source == this.parsingFPCheckBox) {
			...
			this.parsingOptions.setVbr_calc_mode(avparsing.AVParser.VBR_BY_PACKET_BITRATE);
		} else if (source == this.parsingVbrSizeRadioButton) {
			this.parsingVbrBitrateRadioButton.setSelected(!isEnabled);
			this.parsingOptions.setVbr_calc_mode(avparsing.AVParser.VBR_BY_PACKET_SIZE);
