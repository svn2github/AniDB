...
namespace AVDump2Lib.InfoGathering.Parser.MediaInfoLib {
	public class MediaInfo_x64 : IMediaInfo {
		...
		[DllImport("MediaInfo_x64.dll", EntryPoint = "MediaInfo_Open", CharSet = CharSet.Unicode)]
		...
		~MediaInfo_x64() { MediaInfo_Delete(Handle); }
