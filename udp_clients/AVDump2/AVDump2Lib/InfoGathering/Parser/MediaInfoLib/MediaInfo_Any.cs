...
namespace AVDump2Lib.InfoGathering.Parser.MediaInfoLib {
	public class MediaInfo_Any : IMediaInfo {
		...
		[DllImport("MediaInfo.dll", EntryPoint = "MediaInfo_Open", CharSet = CharSet.Unicode)]
		...
		~MediaInfo_Any() { MediaInfo_Delete(Handle); }
