    ...
    for cssfile in filenames:
        if cssfile.endswith('css'):
            ...
            for line in css:
                ...
                line = line.replace('http://static.anidb.net/css/anidbstyle/images/bg','../anidbstyle/images')
                ...
                line = line.replace('http://static.anidb.net/css/anidbstyle/images','../icons')
                line = line.replace('http://anidb.net/css/anidbstyle/images','../icons')
                line = line.replace('http://www.anidb.net/pics','../icons/flags')
                line = line.replace('http://static.anidb.net/pics','../icons/flags')
